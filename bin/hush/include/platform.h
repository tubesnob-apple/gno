...
#if defined(__GNO__)
/* GNO/ORCA/C: enable far-code (JSL/RTL) so linker can span >64KB across banks */
#pragma memorymodel 1
/* Disable lint (0 = off) to suppress spurious warnings from hush sources */
#pragma lint 0
/* Optimize: bits 1+2+3 (jump opt, dataflow, no stack repair code) */
#pragma optimize 14
# undef HAVE_MEMPCPY
# undef HAVE_CLEARENV
# undef HAVE_FDATASYNC
