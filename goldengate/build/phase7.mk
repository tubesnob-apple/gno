...
# ProDOS file type FinderInfo values (set via xattr com.apple.FinderInfo)
...
$(KERN_OUT): $(ALL_KERN_OBJS) | $(OBJ_BASE)
	...
	xattr -wx com.apple.FinderInfo "$(PRODOS_S16_FI)" $(KERN_OUT)
...
$(KERN_OBJ)/%.a: $(KERN_SRC)/%.asm | $(KERN_OBJ)
	...
	xattr -wx com.apple.FinderInfo "$(PRODOS_OBJ_FI)" $(KERN_SRC)/$*.A
...
$(KERN_OBJ)/inout.a: $(DRV_SRC)/inout.asm | $(KERN_OBJ)
	...
	xattr -wx com.apple.FinderInfo "$(PRODOS_OBJ_FI)" $(KERN_SRC)/inout.A
...
$(KERN_OBJ)/console.a: $(DRV_SRC)/console.asm | $(KERN_OBJ)
	...
	xattr -wx com.apple.FinderInfo "$(PRODOS_OBJ_FI)" $(KERN_SRC)/console.A
...
$(KERN_OBJ)/box.a: $(DRV_SRC)/box.asm | $(KERN_OBJ)
	...
	xattr -wx com.apple.FinderInfo "$(PRODOS_OBJ_FI)" $(KERN_SRC)/box.A
...
$(KERN_OBJ)/conpatch.a: $(DRV_SRC)/conpatch.asm | $(KERN_OBJ)
	...
	xattr -wx com.apple.FinderInfo "$(PRODOS_OBJ_FI)" $(KERN_SRC)/conpatch.A
...
$(DRV_OBJ)/null.a: $(DRV_SRC)/null.asm | $(DRV_OBJ)
	...
	xattr -wx com.apple.FinderInfo "$(PRODOS_OBJ_FI)" $(DRV_SRC)/null.A
...
$(DEV_OUT)/null: $(DRV_OBJ)/null.a | $(DEV_OUT)
	...
	xattr -wx com.apple.FinderInfo "$(PRODOS_DRV_FI)" $(DEV_OUT)/null

# zero
$(DRV_OBJ)/zero.a: $(DRV_SRC)/zero.asm | $(DRV_OBJ)
	cd $(DRV_SRC) && $(AS) $(ASFLAGS) zero.asm
	xattr -wx com.apple.FinderInfo "$(PRODOS_OBJ_FI)" $(DRV_SRC)/zero.A
...
$(DEV_OUT)/zero: $(DRV_OBJ)/zero.a | $(DEV_OUT)
	...
	xattr -wx com.apple.FinderInfo "$(PRODOS_DRV_FI)" $(DEV_OUT)/zero

# full
$(DRV_OBJ)/full.a: $(DRV_SRC)/full.asm | $(DRV_OBJ)
	cd $(DRV_SRC) && $(AS) $(ASFLAGS) full.asm
	xattr -wx com.apple.FinderInfo "$(PRODOS_OBJ_FI)" $(DRV_SRC)/full.A
...
$(DEV_OUT)/full: $(DRV_OBJ)/full.a | $(DEV_OUT)
	...
	xattr -wx com.apple.FinderInfo "$(PRODOS_DRV_FI)" $(DEV_OUT)/full
...
$(DRV_OBJ)/console_drv.a: $(DRV_SRC)/console.asm | $(DRV_OBJ)
	...
	xattr -wx com.apple.FinderInfo "$(PRODOS_OBJ_FI)" $(DRV_SRC)/console.A
...
$(DRV_OBJ)/inout_drv.a: $(DRV_SRC)/inout.asm | $(DRV_OBJ)
	...
	xattr -wx com.apple.FinderInfo "$(PRODOS_OBJ_FI)" $(DRV_SRC)/inout.A
...
$(DRV_OBJ)/box_drv.a: $(DRV_SRC)/box.asm | $(DRV_OBJ)
	...
	xattr -wx com.apple.FinderInfo "$(PRODOS_OBJ_FI)" $(DRV_SRC)/box.A
...
$(DRV_OBJ)/conpatch_drv.a: $(DRV_SRC)/conpatch.asm | $(DRV_OBJ)
	...
	xattr -wx com.apple.FinderInfo "$(PRODOS_OBJ_FI)" $(DRV_SRC)/conpatch.A
...
$(DEV_OUT)/console: $(DRV_OBJ)/console_drv.a $(DRV_OBJ)/inout_drv.a \
	...
	xattr -wx com.apple.FinderInfo "$(PRODOS_DRV_FI)" $(DEV_OUT)/console
